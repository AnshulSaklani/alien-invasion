...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    for bullet in bullets.copy():  # You shouldn’t remove items from a list or group within a for loop,
        if bullet.rect.bottom <= 0: # so we have to loop over a copy of the group.
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #have collided.Two true arguments tell Pygame whether to delete
    ...
    if len(aliens) == 0:
        ...
        #To store the score at the beginning of the level
        stats.scr = stats.score
